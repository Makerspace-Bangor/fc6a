<pre>
Objective: Play DOOM on the HMI!
...
00000030  6f 73 5f 75 70 64 61 74  65 2e 74 61 72 2e 78 7a <red> |os_update.tar.xz|</red>
00000040  00 00 00 00 02 00 00 00  c4 b5 6b 02 34 89 2c 00  |..........k.4.,.|
00000050  2e c4 36 55 0c 00 00 00  70 72 6f 6a 65 63 74 2e  |..6U....<red>project.|
00000060  7a 6e 76 00 fd 37 7a 58  5a 00 00 01 69 22 de 36  |znv</red>..7zXZ...i".6|
...
Im thinking that the end of the tar.xz file must be in the znx file, 
...
List of files from os_update.tar.xz >> see untar.txt
...
I wonder if github cares about that. I certainly hope not because Im tired AF, 
